                    ...
                    <td className="p-3 text-center">
                      <div className="flex items-center gap-1.5 justify-center">
                        <button 
                          ...
                          className="p-1 px-2 text-indigo-950 bg-indigo-55/10 hover:bg-indigo-900 hover:text-white border border-indigo-200 hover:border-indigo-900 rounded-lg font-black text-[10px] transition-all flex items-center justify-center gap-1 cursor-pointer"
                          title="تحميل وطبع الوصل المالي للقبول"
                        >
                          <Printer className="w-3 h-3 shrink-0" />
                          <span>طبع</span>
                        </button>
                        {(currentRole === 'admin' || currentRole === 'finance_director') && (
                          <button 
                            onClick={() => onDeletePayment(pay.id)}
                            className="p-1 px-2 text-rose-650 bg-rose-50 hover:bg-rose-600 hover:text-white border border-rose-200 hover:border-rose-600 rounded-lg font-bold text-[10px] transition-all flex items-center justify-center gap-1 cursor-pointer active:scale-95 shadow-sm"
                            title="حذف وإلغاء هذا الإيصال المالي كلياً"
                          >
