...
export const mockStudents: Student[] = [
  {
    ...
    documents: [
      ...
      { id: 'doc-2', name: 'البطاقة الوطنية الموحدة (أو الجنسية)', provided: true, receivedDate: '2026-01-15' },
      { id: 'doc-3', name: 'شهادة الفحص الطبي الصادرة من دائرة الصحة', provided: true, receivedDate: '2026-01-18' },
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'doc-2', name: 'البطاقة الوطنية الموحدة (أو الجنسية)', provided: true, receivedDate: '2026-02-10' }, // منتهية الصلاحية للتجربة!
      { id: 'doc-3', name: 'شهادة الفحص الطبي الصادرة من دائرة الصحة', provided: true, receivedDate: '2026-02-10' }, // تنتهي قريباً للتجربة!
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'doc-2', name: 'البطاقة الوطنية الموحدة (أو الجنسية)', provided: true, receivedDate: '2025-09-10' },
      { id: 'doc-3', name: 'شهادة الفحص الطبي الصادرة من دائرة الصحة', provided: true, receivedDate: '2025-09-12' }, // مُنتهية!
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'doc-2', name: 'البطاقة الوطنية الموحدة (أو الجنسية)', provided: true, receivedDate: '2026-02-18' },
      { id: 'doc-3', name: 'شهادة الفحص الطبي الصادرة من دائرة الصحة', provided: true, receivedDate: '2026-02-20' },
  ...
  },
  {
    ...
    documents: [
      ...
      { id: 'doc-2', name: 'البطاقة الوطنية الموحدة (أو الجنسية)', provided: true, receivedDate: '2026-01-20' },
