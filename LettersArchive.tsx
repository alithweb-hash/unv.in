          ...
          return (
            ...
            >
              ...
              <div className="border-t border-slate-100 pt-3 flex flex-col gap-2 Text-xs">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-slate-50/50 p-2 rounded-xl text-[10px] font-mono text-slate-500 gap-2">
                  <div className="flex items-center gap-1 font-bold text-red-00 font-sans text-red-800">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                    ...
                    {(currentRole === 'admin' || currentRole === 'registration_director') && (
                      <button 
                        ...
                        className="p-1 px-1.5 text-red-600 hover:text-white hover:bg-red-600 border border-red-200 hover:border-red-650 rounded-md transition-all font-bold flex items-center gap-1 cursor-pointer active:scale-95"
                        title="حذف وحذف الصلاحية"
                      >
